  ...
  builtins.foldl'
    (
      ...
      # Standard shell attributes
      {
        ...
        nativeBuildInputs =
          (a.nativeBuildInputs or [ ]) ++ (b.nativeBuildInputs or [ ]);
        propagatedBuildInputs =
          (a.propagatedBuildInputs or [ ]) ++ (b.propagatedBuildInputs or [ ]);
        propagatedNativeBuildInputs =
          (a.propagatedNativeBuildInputs or [ ])
          ++ (b.propagatedNativeBuildInputs or [ ])
        ;
